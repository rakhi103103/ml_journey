...
# Q-----Q7 – Find Duplicate Elements in List------------
n1 = int(input("Enter number of array: "))
arr1=[]
for i in range(n1):
    num1 = int(input("Enter the numbers: "))
    arr1.append(num1)
print(f"The numbers in the list : {arr1}")
dup=[]

for i in arr1:
    if arr1.count(i)>1 and i not in dup:
        dup.append(i)
for i in dup:
    print(f"the duplicate numbers are {dup} ")
